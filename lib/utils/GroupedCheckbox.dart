...
class GroupedCheckbox extends StatefulWidget {
  ...
  final List<ArrayItemList> disabled;
...
class _GroupedCheckboxState extends State<GroupedCheckbox> {
  List<ArrayItemList> selectedListItems = List<ArrayItemList>();
  ...
  Widget item(int index) {
    return Row(
      ...
      children: <Widget>[
        ...
        Text(
          widget.itemList[index].paramsOne +
              ' - ' +
              widget.itemList[index].paramsTwo,
